#!/usr/bin/env python3
"""EXP-003 Clausura 2025 J14 model-only replay.

Temporal contract
-----------------
- Target slate: Clausura 2025 Jornada 14, 4-6 April 2025.
- One global model freeze at 2025-04-04 00:00. No J14 result is eligible.
- J1-J13 are historical and may enter training.
- External price/context snapshot cutoff: 2025-04-04 18:59 America/Mexico_City.
...
MODEL_CUTOFF = datetime(2025, 4, 4, 0, 0, 0)
CONTEXT_CUTOFF = "2025-04-04T18:59:00-06:00"
EXPECTED_TRAINING_ROWS = 964

FIXTURES = [
    ("J14-01", "2025-04-04", "Gallos Blancos", "Club León"),
    ("J14-02", "2025-04-04", "Club Tijuana", "Club Necaxa"),
    ("J14-03", "2025-04-04", "Puebla FC", "UANL Tigres"),
    ("J14-04", "2025-04-05", "Atlas Guadalajara", "FC Juárez"),
    ("J14-05", "2025-04-05", "CF Pachuca", "CF América"),
    ("J14-06", "2025-04-05", "Atlético San Luis", "Mazatlán FC"),
    ("J14-07", "2025-04-05", "CF Monterrey", "Deportivo Guadalajara"),
    ("J14-08", "2025-04-05", "Cruz Azul", "Pumas UNAM"),
    ("J14-09", "2025-04-06", "Deportivo Toluca", "Santos Laguna"),
]
...
def main():
    ...
    if len(tr) != EXPECTED_TRAINING_ROWS:
        raise SystemExit(f"J14 chronology drift: expected {EXPECTED_TRAINING_ROWS}, got {len(tr)}")
    ...
    out = {
        "track": "HISTORICAL_J14_MODEL_ONLY_PRE_CONTEXT",
        ...
        "warning": "MODEL_ONLY pre-context. Human researcher is outcome-exposed for J14; selection must remain deterministic model+price only."
    }
    print("J14_MODEL_ONLY_OUTPUT", json.dumps(out, ensure_ascii=False, sort_keys=True), flush=True)
